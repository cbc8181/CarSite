...
import { updateInventory } from '@/app/lib/action';
...
export default function Form({
    ...
    // const updateInventoryWithId = updateInventory.bind(null, car.id.toString());

    const initialState = { message: '', errors: {} };
    const [state, dispatch] = useFormState(updateInventory, initialState);
                ...
                <div className=' grid grid-cols-12 gap-6'>
                    ...
                    <div className='  col-span-6 xl:col-span-4 2xl:col-span-3'>
                        <div className=' w-full flex items-center'>
                            ...
                            <input
                                id='listprice'
                                name='listprice'
                                defaultValue={car.listPrice as number}
                                type='number'
                                step='1'
                    ...
                    <div className='col-span-6 xl:col-span-4 2xl:col-span-3'>
                        <div className=' w-full flex items-center'>
                            ...
                            <input
                                id='exteriorColor'
                                name='exteriorColor'
                                defaultValue={car.exteriorColor}
                                type='text'
                    ...
                    <div className=' col-span-6 xl:col-span-4 2xl:col-span-3 '>
                        <div className=' w-full flex items-center'>
                            ...
                            <input
                                id='displacement'
                                name='displacement'
                                defaultValue={car.displacement as unknown as number}
                                type='number'
                                step='0.1'
                    ...
                    </fieldset>
                    {
                        featureCategories.map((category) => {
                            ...
                            return (
                                <div className=' col-span-12' key={`features.${category}`}>
                                    <CheckFeatures category={category} features={iFeatures} carFeatures={car.carFeatures}/>
                                </div>
                            )
                        })
                    }
